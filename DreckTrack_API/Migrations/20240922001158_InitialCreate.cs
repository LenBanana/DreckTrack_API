        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CollectibleItemId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExternalId_CollectibleItems_CollectibleItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Season_CollectibleItems_ShowId",
                        column: x => x.ShowId,
                        principalTable: "CollectibleItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserCollectibleItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserCollectibleItems_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserCollectibleItems_CollectibleItems_CollectibleItemId",
                        column: x => x.CollectibleItemId,
                        principalTable: "CollectibleItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "UserShowEpisodeProgress",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserCollectibleItemId = table.Column<Guid>(type: "uuid", nullable: false),
                    SeasonNumber = table.Column<int>(type: "integer", nullable: false),
                    EpisodeNumber = table.Column<int>(type: "integer", nullable: false),
                    Watched = table.Column<bool>(type: "boolean", nullable: false),
                    WatchedOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserShowEpisodeProgress", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserShowEpisodeProgress_UserCollectibleItems_UserCollectibl~",
                        column: x => x.UserCollectibleItemId,
                        principalTable: "UserCollectibleItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalId_CollectibleItemId",
                table: "ExternalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserCollectibleItems_CollectibleItemId",
                table: "UserCollectibleItems",
                column: "CollectibleItemId");

            migrationBuilder.CreateIndex(
                name: "IX_UserCollectibleItems_UserId",
                table: "UserCollectibleItems",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserShowEpisodeProgress_UserCollectibleItemId",
                table: "UserShowEpisodeProgress",
                column: "UserCollectibleItemId");
        }
